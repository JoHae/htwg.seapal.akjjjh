...
while ($row = mysql_fetch_array($result)) {
	echo "<tr>
         ...
         <td></td>
         <td><input type=\"button\" name=\"edit_" . $row['waypointID'] . "\" value=\"Editieren\" onclick=\"Popup=window.open('../app/dialogs/waypoint_edit.php?waypointID=" . $row['waypointID'] . "',
...
echo "</table>";
mysql_close($con);
echo "<input type=\"button\" name=\"new_waypoint\" value=\"Neuer Wegpunkt\" onclick=\"Popup=window.open('../app/dialogs/waypoint_edit.php?tripID=" . $_GET['tripID'] . "&waypointID=NULL',
