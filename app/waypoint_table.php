...
while ($row = mysql_fetch_array($result)) {
	echo "<tr>
         ...
         <td></td>
         <td><input type=\"button\" name=\"edit_" . $row['waypointID'] . "\" value=\"Editieren\" onclick=\"Popup=window.open('../app/dialogs/trip_edit.php?tripID=" . $row['tripID'] . "',
...
echo "</table>";
mysql_close($con);
echo "<input type=\"button\" name=\"new_trip\" value=\"Neuer Trip\" onclick=\"Popup=window.open('../app/dialogs/waypoint_edit.php?tripID=" . $_GET['tripID'] . "&waypointID=NULL',
