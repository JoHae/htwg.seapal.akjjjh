...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head profile="http://www.w3.org/2005/10/profile">
		...
		<link href="./SeaPal_files/css" rel="stylesheet" type="text/css">
		<link href="./SeaPal_files/style.css" rel="stylesheet" type="text/css" media="screen">

		<!-- Google Analytics code -->
		<script src="./SeaPal_files/cb=gapi.loaded_0" async=""></script>
		<script id="twitter-wjs" src="./SeaPal_files/widgets.js"></script>
		<script type="text/javascript" async="" src="./SeaPal_files/plusone.js" gapi_processed="true"></script>
		<script id="facebook-jssdk" src="./SeaPal_files/all.js"></script>
		<script type="text/javascript" async="" src="./SeaPal_files/ga.js"></script>
				...
				<div id="menu">
					<ul>
						<li class="current_page_item">
							<a href="./SeaPal_files/SeaPal.htm">Homepage</a>
						</li>
						<li>
							<a href="http://www.seapal.de/userguide.php">User Guide</a>
						</li>
						<li>
							<a href="http://www.seapal.de/screenshots.php">Screenshots</a>
						</li>
						<li>
							<a href="http://www.seapal.de/about.php">About</a>
						</li>
						<li>
							<a href="http://www.seapal.de/contact.php">Contact</a>
						</li>
					</ul>
				</div>
			</div>
			...
			<div id="page" class="container">
				...
				<div id="sidebar">
					...
					<div id="column1">
						...
						<ul class="list-style1">
							<li class="first">
								<a href="http://itunes.apple.com/us/app/seapal/id561903907?mt=8&uo=4" target="itunes_store"><img src="./SeaPal_files/Icon-Small-50.png" alt="Icon-Small-50" width="20" height="20"> iPad App Store</a>
							</li>
							<li><img src="./SeaPal_files/Icon-Small-50.png" alt="Icon-Small-50" width="20" height="20"> iPhone App Store
							</li>
						</ul>
					...
					<div id="column2">
						...
						<div class="fb-like fb_edge_widget_with_comment fb_iframe_widget" data-href="http://www.SeaPal.info" data-send="true" data-width="300" data-show-faces="true" fb-xfbml-state="rendered">
							<span style="height: 28px; width: 300px; "><iframe id="fabc9bbc" name="f204048efc" scrolling="no" style="border: none; overflow: hidden; height: 28px; width: 300px; " title="Like this content on Facebook." class="fb_ltr" src="./SeaPal_files/like.htm"></iframe></span>
						</div>

					</div>
					<!-- Twitter button-->
					<div>
						<iframe allowtransparency="true" frameborder="0" scrolling="no" src="./SeaPal_files/tweet_button.1347008535.htm" class="twitter-share-button twitter-count-horizontal" style="width: 110px; height: 20px; " title="Twitter Tweet Button" data-twttr-rendered="true"></iframe>
						<script>
							! function(d, s, id) {
					...
					<div id="column3">
						...
						<ul class="list-style1">
							<li class="first">
								<a href="http://www.seapal.de/impressum.php">Impressum</a>
							</li>
							<li>
								<a href="http://www.seapal.de/legal.php">Legal notice</a>
							</li>
						</ul>
					</div>
				</div>
